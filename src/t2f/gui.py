...
#---------------------------------------------------------------------------
APPNAME = "九九下载-天地图转GeoTIF/IMG文件"
LICENSE_APP_NAME = "t2f"
...
class DownloadFrame(wx.Frame):
    def __init__(
        ...
        label=wx.StaticText(panel, -1, "天地图经纬度范围, 格式为(英文逗号隔开):最小经度,最大维度,最大经度,最小维度, 例如: -180,90,180,-90")
	...
	def _add_level(panel, sizer):
	    label=wx.StaticText(panel, -1, "天地图层级, 取值为[ 2, 18]:")
